  ...
  <div class="tab-view-container">
    ...
    <div class="settings-action-card">
      <div class="card-head-row">
        <div>
          <h3 class="card-title">
            ...
            <span>ตั้งค่าเป้าหมาย & ข้อมูล</span>
          </h3>
          <span class="card-sub">ปรับแต่งเป้าหมายสารอาหารและจัดการข้อมูลประวัติอาหาร</span>
        </div>
        <button 
          type="button" 
      ...
      <div class="key-status-indicator">
        ...
        <span class="status-text">ระบบ AI โภชนาการ ({{ getActiveAiProvider() }}) พร้อมใช้งาน</span>
      </div>
    </div>
  </div>
</template>
...
import { getActiveAiProvider } from '../../services/nutritionApi.js';
</script>
